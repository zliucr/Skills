...
generate(
    ...
    server_gpus=8,
    input_file="/lustre/fsw/portfolios/llmservice/users/dongfuj/Workspace/Skills/data/startercode_v1_clean_problems.jsonl",
    # generations will be here. Needs to be a mounted folder
    output_dir="/lustre/fsw/portfolios/llmservice/users/dongfuj/Workspace/Skills/gpt-oss-sdg/with-python/startercode_v1",
